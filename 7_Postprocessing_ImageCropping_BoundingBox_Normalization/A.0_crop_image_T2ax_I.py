...
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/preRadiomics/T2*Mask_i"
os.chdir(src)

images = glob.glob("*ax.nii")
images.sort()
print("images = ", images)

dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/preRadiomics/T2*Mask_i/output"
