...
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/Registration"
os.chdir(src)

images = glob.glob("*b1000_f.nii")
images.sort()
print("images = ", images)
...
dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/preRadiomics/b1000*Mask_i"
