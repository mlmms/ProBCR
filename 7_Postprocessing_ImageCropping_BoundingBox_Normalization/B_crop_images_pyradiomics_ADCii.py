...
#1st analysis:  PROSTATE only, no surrounding tissues
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.3_ADC/Analysis_II(withbackground)/3_BB_input"
dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.3_ADC/Analysis_II(withbackground)/4_BB_output"

os.chdir(src)

list_images = sorted(glob.glob("ADC*"))
cases = list_images
for i in range(len(list_images)):
    cases[i] = list_images[i][8:12]
