...
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.3_ADC/Analysis_I(nobackground)/3_BB_input"
dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.3_ADC/Analysis_I(nobackground)/4_BB_output"

os.chdir(src)

list_images = sorted(glob.glob("crpADC*"))
cases = list_images
for i in range(len(list_images)):
    cases[i] = list_images[i][11:15]
