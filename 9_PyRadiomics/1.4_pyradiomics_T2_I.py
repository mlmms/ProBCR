...
# 0_Setting up data
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.0_T2ax/Analysis_I_nobackground/5_pyRadiomics_input"
dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.0_T2ax/Analysis_I_nobackground/6_pyRadiomics_output"

OUTPUTCSV = os.path.join(dst, "results_2020_t2_I_bin_method_99p.csv")
HEADERS = None
os.chdir(src)
...
paramPath = "/Users/monicasilva/PycharmProjects/ProBCR/radiomics_kit/data_T2_I.yml"
...
#######################################################
# Loop to define parameter "h_mean", for binning method
#######################################################
