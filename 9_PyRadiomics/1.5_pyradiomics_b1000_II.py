# DWI radiomics, for multiparametric MRI, for PCa * MMS, 2019
...
# 0_Setting up data
src = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.2_DWIb1000/Analysis_II(withbackground)/5_pyRadiomics_input"
dst = "/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/pre_PyRadiomics/6.2_DWIb1000/Analysis_II(withbackground)/6_pyRadiomics_output"

OUTPUTCSV = os.path.join(dst, "results_2020_b1000_II_bin_method_99.csv")
HEADERS = None
os.chdir(src)
...
paramPath = "/Users/monicasilva/PycharmProjects/ProBCR/radiomics_kit/data_DWI_II.yml"
