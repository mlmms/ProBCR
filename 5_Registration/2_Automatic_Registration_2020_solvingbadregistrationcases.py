# Cases with bad registration
# P093, 97, 126, 129, 139, 206

import SimpleITK as sitk
from natsort import natsorted
import os
os.chdir("/Users/monicasilva/Documents/1_Original_data/Final_Cohort_2020_99p/Registration_solvingbadcases_correct_resamplingtob0notT2")
...
while y < 71:
    ...
    fixedImage = sitk.ReadImage(movingImage_path) # b0 -> T2
    movingImage = sitk.ReadImage(fixedImage_path) # T2 -> b0
    labelImage = sitk.ReadImage(label_path)
    fixedMask = sitk.BinaryThreshold(fixedImage, 50, 50000, 1, 0)  # or 250 for patient P093 and P097, the remaining its with 50
    ...
    #esampler.SetReferenceImage(fixedImage) #b0
    resampler.SetReferenceImage(movingImage) #b0
