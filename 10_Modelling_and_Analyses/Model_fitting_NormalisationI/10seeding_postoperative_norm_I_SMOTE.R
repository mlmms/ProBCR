...
BASE <- "/Users/monicasilva/Documents/Thesis_Writing/4_Results/4_Results_Normalization_I/3_POSTOPERATIVE/PLII_seedingPAIRS_SMOTE_"
...
for (i in 1:length(pmaxs_value)) {
  for (j in 1:length(SEED)) { #length(SEED)
    ...
    results_path <- paste0(BASE,"PostOperative_PLII_SMOTEoversampling.xlsx")
