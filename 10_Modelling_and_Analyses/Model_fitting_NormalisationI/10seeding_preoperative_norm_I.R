...
BASE <- "/Users/monicasilva/Documents/Thesis_Writing/4_Results/4_Results_Normalization_I/2_PREOPERATIVE/PLII_seedingPAIRS"
...
for (i in 1:length(pmaxs_value)) {
  for (j in 1:length(SEED)) { #length(SEED)
    ...
    t2_ii_path <- "/Users/monicasilva/Documents/Final_Radiomics_Extraction_Force2DTRUE/results_2020_t2_I_bin_method_93p.csv"
    b1000_ii_path <- "/Users/monicasilva/Documents/Final_Radiomics_Extraction_Force2DTRUE/results_2020_b1000_I_bin_method_93p.csv"
    adc_ii_path <- "/Users/monicasilva/Documents/Final_Radiomics_Extraction_Force2DTRUE/results_2020_adc_I_bin_method_93p.csv"
