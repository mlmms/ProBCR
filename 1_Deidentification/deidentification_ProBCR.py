...
#dst="/Volumes/TOSHIBA_EXT/ProBCR_Ext_Deid_158_2XX"
src="/Users/monicasilva/Documents/1.1_Additional_data"
dst="/Users/monicasilva/Documents/1.1_Additional_data_deid"
...
for root, directories, fileNames in os.walk(src):
    if root == "/Users/monicasilva/Documents/1.1_Additional_data/S50710":
        break
    ...
    for directory in listOfDirectories:
        ...
        with open(os.path.join(dst, "DeID_Coding_BCR_Prostate_1_157" + ".csv"), "a") as f:
            writer = csv.writer(f)
